...
interface IButtonwoodRouter is IButtonwoodRouterErrors {
     ...
     * @notice If the pair is empty, amountAMin and amountBMin are ignored.
     * @notice If the pair is nonempty, it deposits as much of tokenA and tokenB as possible while maintaining 3 conditions:
     * 1. The ratio of tokenA to tokenB in the pair is the same
